<x-admin.dashboard>
  ...
  <div
    class="bg-white rounded-2xl shadow-lg w-full max-w-[600px] mx-auto text-[14px] overflow-hidden">
    <div
    ...
    <form action="" method="post" class="p-7 space-y-6">
      ...
      <div class="flex flex-col gap-1">
        ...
        <input type="text" id="kode_buku" name="kode_buku"
          class="w-full border border-[#9BA4B5] rounded px-3 py-2 focus:border-[#394867] focus:ring-[#394867]"
          placeholder="Ketik kode/judul buku dipinjam (bisa lebih dari satu, pisahkan koma)"
          required>
