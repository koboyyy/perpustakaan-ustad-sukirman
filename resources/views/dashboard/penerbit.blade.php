          ...
          <div class="flex flex-col items-center gap-3">
            ...
            <div class="flex gap-3 items-center justify-center w-full">
              ...
              <button type="button" id="konfirmasiHapusBtn"
                class="bg-red-700 hover:bg-red-700 text-white font-semibold px-5 py-2 rounded-lg transition flex items-center gap-2">
                  ...
                  <tr class="hover:bg-[#F1F6F9]/50 transition">
                    ...
                    <td class="border border-[#9BA4B5] px-3 py-2">
                      <div class="flex justify-center gap-2">
                        <button type="button"
                          class="bg-red-700 hover:bg-red-700 text-white px-3 py-1 rounded transition hapusPenerbitBtn"
                          data-id="{{ $penerbit->id }}"
