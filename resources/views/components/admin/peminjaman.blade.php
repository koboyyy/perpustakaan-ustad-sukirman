  ...
  <div
    ...
    <div class="w-full p-[24px]">
      <form action="" method="POST" class="space-y-6">
        ...
        <div class="flex flex-col gap-1">
          <label for="data_buku"
            class="text-[14px] after:content-['*'] after:text-purple-600 after:ml-1">Judul Buku
          ...
          <span class="text-xs text-purple-500 mt-1">Jika ingin pinjam lebih dari satu buku,
        ...
        <div>
          <button type="submit"
            class="w-full bg-purple-600 text-white py-3 font-semibold hover:bg-purple-700 transition-colors rounded">
            Simpan Peminjaman
          </button>
        </div>
      </form>
