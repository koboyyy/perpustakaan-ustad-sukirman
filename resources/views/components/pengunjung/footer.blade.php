<div class="md:p-4">
  <footer
    class="relative bg-linear-to-tr from-[#212A3E] via-[#394867] to-[#9BA4B5] py-16 px-6 sm:px-12 text-white overflow-hidden z-10 md:rounded-4xl">
    <!-- Bulatan dekoratif background -->
    <div class="absolute left-0 -top-20 w-72 h-72 bg-[#9BA4B5] opacity-20 rounded-full blur-3xl z-0">
    </div>
    <div
      class="absolute right-0 bottom-0 w-80 h-80 bg-[#638ECB] opacity-15 rounded-full blur-3xl z-0">
    </div>
    <!-- Konten utama footer -->
    <div
      ...
      <div class="flex-1 min-w-[250px]">
        ...
        <p class="text-[#EEF3F7]/80 leading-relaxed text-sm mb-6 max-w-md">
          ...
          Perpustakaan Ustadz Sukirman diresmikan oleh Bupati Bengkalis pada tanggal 17 Desember
          2019.
        </p>
        <div class="mt-6 flex items-center gap-3">
          ...
          <a href="#" class="hover:scale-110 transition-transform text-[#638ECB]">
            <i class="fa-solid fa-envelope text-2xl"></i>
          </a>
          <a href="#" class="hover:scale-110 transition-transform text-[#394867]">
      ...
      <div class="flex-1 min-w-[230px]">
        ...
        <div
          class="rounded-xl overflow-hidden shadow-lg ring-2 ring-[#394867]/20 max-w-xs md:max-w-sm lg:max-w-md">
          <iframe
            ...
            class="w-full h-[200px] md:h-[250px] lg:h-[280px]" style="border:0" allowfullscreen=""
            loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        <div class="mt-2 text-xs text-[#B0C4D9]">Wonosari, Bengkalis, Riau</div>
      </div>
      <!-- Kolom 3: Jam & Kontak -->
        ...
        <div>
          ...
          <ul class="text-[#EEF3F7]/90 text-sm space-y-3">
            ...
            <li>
              ...
              <span class="block text-xs text-[#9BA4B5]">LAYANAN TEKNIS</span>
              <span class="flex items-center gap-2 mt-1">
                <i class="fa-brands fa-whatsapp text-lg text-green-400"></i>
    ...
    <!-- Footer Bawah -->
    {{-- <div
      class="border-t border-[#394867]/60 pt-6 text-xs text-center text-[#EEF3F7]/70 tracking-wider z-10 relative">
