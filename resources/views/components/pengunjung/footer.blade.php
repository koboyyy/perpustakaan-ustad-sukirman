<footer
  ...
  <div class="absolute right-0 bottom-0 w-80 h-80 bg-[#638ECB] opacity-15 rounded-full blur-3xl z-0">
  </div>
  <!-- Konten utama footer -->
  <div
    ...
    <div class="flex-1 min-w-[230px]">
      ...
      <div class="rounded-xl overflow-hidden shadow-lg ring-2 ring-[#394867]/20 max-w-xs">
        <iframe
  ...
  <!-- Footer Bawah -->
  <div
    class="mt-12 border-t border-[#394867]/60 pt-6 text-xs text-center text-[#EEF3F7]/70 tracking-wider z-10 relative">
