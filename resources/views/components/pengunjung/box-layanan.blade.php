<div class="bg-[#394867] py-16 md:py-24 relative overflow-hidden rounded-t-[px]">
  {{-- Dekorasi background --}}
  <div
  ...
  {{-- Title --}}
  <div class="space-y-1 mb-8 sm:mb-10 px-2 sm:px-0">
    <div
      class="text-xl sm:text-2xl md:text-3xl font-bold text-center text-[rgb(251,251,251)] leading-snug sm:leading-tight">
      Layanan Kami
    </div>
    <div
  ...
  <div
    class="w-full flex flex-col gap-5 sm:gap-8 md:flex-row items-stretch justify-center text-lg sm:text-2xl max-w-7xl mx-auto z-10 relative px-4 sm:px-10 md:px-20">
    {{-- CARD 1 --}}
    <div
